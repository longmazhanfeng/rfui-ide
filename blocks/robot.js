...
Blockly.Blocks['setting_documentation'] = {
  /**
   * Block for setting documentation
   * @this Blockly.Block
   */
  init: function() {
    this.setColour(Blockly.Blocks.lists.HUE);
  ...
  updateShape_: function() {
    ...
    if (this.itemCount_ == 0) {
      this.appendDummyInput('EMPTY')
          .appendField(Blockly.Msg.rfui.SETUP);
    } else {
      for (var i = 0; i < this.itemCount_; i++) {
        var input = this.appendValueInput('ADD' + i);
        if (i == 0) {
          input.appendField(Blockly.Msg.rfui.SETUP);
        }
      }
    }
  }
...
Blockly.Blocks['setting_tags'] = {
  ...
  updateShape_: function() {
    ...
    if (this.itemCount_ == 0) {
      this.appendDummyInput('EMPTY')
          .appendField(Blockly.Msg.rfui.TAGS);
    } else {
      for (var i = 0; i < this.itemCount_; i++) {
        var input = this.appendValueInput('ADD' + i);
        if (i == 0) {
          input.appendField(Blockly.Msg.rfui.TAGS);
        }
      }
    }
  }
...
Blockly.Blocks['setting_teardown'] = {
  ...
  updateShape_: function() {
    ...
    if (this.itemCount_ == 0) {
      this.appendDummyInput('EMPTY')
          .appendField(Blockly.Msg.rfui.TEARDOWN);
    } else {
      for (var i = 0; i < this.itemCount_; i++) {
        var input = this.appendValueInput('ADD' + i);
        if (i == 0) {
          input.appendField(Blockly.Msg.rfui.TEARDOWN);
        }
      }
    }
  }
